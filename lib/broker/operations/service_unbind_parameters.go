...
func NewServiceUnbindParams() ServiceUnbindParams {
	var ()
	return ServiceUnbindParams{}
}

// ServiceUnbindParams contains all the bound params for the service unbind operation
// typically these are obtained from a http.Request
//
// swagger:parameters serviceUnbind
type ServiceUnbindParams struct {
...
func (o *ServiceUnbindParams) bindBindingID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ServiceUnbindParams) bindInstanceID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
