...
type GetServicePlansHandlerFunc func(GetServicePlansParams) (*[]genmodel.Plan, error)

func (fn GetServicePlansHandlerFunc) Handle(params GetServicePlansParams) (*[]genmodel.Plan, error) {
	return fn(params)
}

// GetServicePlansHandler interface for that can handle valid get service plans params
type GetServicePlansHandler interface {
	Handle(GetServicePlansParams) (*[]genmodel.Plan, error)
}
