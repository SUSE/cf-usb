...
func (o *GetDriverParams) bindAuthorization(raw string, formats strfmt.Registry) error {
...
func (o *GetDriverParams) bindDriverID(raw string, formats strfmt.Registry) error {
