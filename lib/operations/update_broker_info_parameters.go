...
func (o *UpdateBrokerInfoParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *UpdateBrokerInfoParams) bindAuthorization(raw string, formats strfmt.Registry) error {
