...
func (o *CreateConnectionCreated) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
...
// WriteResponse to the client
func (o *CreateConnectionDefault) WriteResponse(rw http.ResponseWriter, producer httpkit.Producer) {
