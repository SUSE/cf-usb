...
// NewMysqlDriverAPI creates a new MysqlDriver instance
func NewMysqlDriverAPI(spec *spec.Document) *MysqlDriverAPI {
	o := &MysqlDriverAPI{
		spec:            spec,
...
/*MysqlDriverAPI The first version of the Catalog Service Manager API.
...
func (o *MysqlDriverAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *MysqlDriverAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// DefaultProduces returns the default produces media type
func (o *MysqlDriverAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *MysqlDriverAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *MysqlDriverAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *MysqlDriverAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the MysqlDriverAPI
func (o *MysqlDriverAPI) Validate() error {
...
func (o *MysqlDriverAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *MysqlDriverAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]httpkit.Authenticator {
...
func (o *MysqlDriverAPI) ConsumersFor(mediaTypes []string) map[string]httpkit.Consumer {
...
func (o *MysqlDriverAPI) ProducersFor(mediaTypes []string) map[string]httpkit.Producer {
...
func (o *MysqlDriverAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
func (o *MysqlDriverAPI) initHandlerCache() {
	if o.context == nil {
...
func (o *MysqlDriverAPI) Serve(builder middleware.Builder) http.Handler {
	if len(o.handlers) == 0 {
		o.initHandlerCache()
	}
