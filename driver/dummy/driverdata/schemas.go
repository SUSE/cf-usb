...
func schemasConfigJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "schemas/config.json", size: 184, mode: os.FileMode(420), modTime: time.Unix(1444831048, 0)}
...
func schemasDialsJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "schemas/dials.json", size: 178, mode: os.FileMode(420), modTime: time.Unix(1444826805, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
